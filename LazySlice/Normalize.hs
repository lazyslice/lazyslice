{-# LANGUAGE ApplicativeDo, FlexibleContexts, FunctionalDependencies, GeneralizedNewtypeDeriving #-}
...
control :: ((Either String Whnf -> ContTy) -> Eval Whnf) -> Eval Whnf
...
whnf rho kappa (Lam a t) h =
    pure $ WLam (Clos rho kappa h a) (Abs rho t)
